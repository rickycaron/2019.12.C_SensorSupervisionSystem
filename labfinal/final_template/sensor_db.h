...
/*
 * Reads continiously all data from the shared buffer data structure and 
 * stores this into the database
 * When *buffer becomes NULL the method finishes. This method will NOT automatically
