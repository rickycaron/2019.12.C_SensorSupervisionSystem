...
dplist_t *dpl_insert_at_index(dplist_t *list, void *element, int index, bool insert_copy)
{
    ...
    list_node = malloc(sizeof(dplist_node_t));      // FIXME: this block has not been freed
...
dplist_node_t *dpl_get_reference_at_index(dplist_t *list, int index)
{
    ...
    return dummy; // if not find, return tail of the list
...
//         list->element_print(node->element);
//         printf("\n");
//         node = node->next;
//         index++;
//     }
